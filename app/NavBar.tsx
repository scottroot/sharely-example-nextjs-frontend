            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link
                ...
                className={clsx(
                  ...
                  pathname === "/" ? "border-indigo-500" : "border-transparent hover:border-gray-300 hover:text-gray-700",
                )}
              >
                Browse Categories
              </Link>
              <Link
                ...
                className={clsx(
                  "inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900",
                  pathname === "/upload" ? "border-indigo-500" : "border-transparent hover:border-gray-300 hover:text-gray-700",
                )}
              >
                Upload
              </Link>
              <Link
                ...
                className={clsx(
                  "inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900",
                  pathname === "/login" ? "border-indigo-500" : "border-transparent hover:border-gray-300 hover:text-gray-700",
                )}
              >
                Login
              </Link>
